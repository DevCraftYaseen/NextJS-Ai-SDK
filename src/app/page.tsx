        ...
        <div className="mx-auto max-w-3xl">
          ...
          <div className="grid w-full gap-3 sm:grid-cols-2 lg:grid-cols-3">
            ...
            >
              ...
              <h3 className="mb-1 text-sm font-semibold text-text-primary">Transcribe</h3>
              <p className="text-sm leading-relaxed text-text-tertiary">
      ...
      <footer className="mt-auto border-t border-border-light bg-surface/50">
        <div className="mx-auto max-w-3xl px-4 py-6 sm:px-6 sm:py-8">
          <div className="flex flex-col items-center gap-5 sm:flex-row sm:justify-between">
            ...
            {/* Center — page links */}
            <div className="flex flex-wrap items-center justify-center gap-x-3 gap-y-1.5 sm:gap-x-4 sm:gap-y-2 max-w-[280px] sm:max-w-none">
